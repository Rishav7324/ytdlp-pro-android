...
// --- Zyvro Penpot Light Liquid Glass Design System Tokens ---
...
val BackgroundDarkSecondary = Color(0xFF0D1B2A)
val SurfaceDark = Color(0xFF112233)
val SurfaceVariantDark = Color(0xFF182D42)
val CardBorderDark = Color(0xFF2E4B66)
...
// --- Zyvro iOS-style smooth system palette ---
// Light: iOS grouped background + white cards; Dark: true-black + elevated cards.
...
val IOSCardDarkElevated = Color(0xFF2C2C2E)

// iOS semantic accents (smooth, calibrated)
...
// iOS large-title + section caption text colors
val IOSTitleLight = Color(0xFF000000)
val IOSCaptionLight = Color(0xFF6C6C70)
val IOSTitleDark = Color(0xFFFFFFFF)
val IOSCaptionDark = Color(0xFF98989F)
